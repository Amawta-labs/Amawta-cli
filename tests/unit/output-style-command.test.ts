...
describe('/output-style (menu + direct set + help)', () => {
  ...
  beforeEach(async () => {
    ...
    projectDir = mkdtempSync(join(tmpdir(), 'amawta-output-style-proj-'))
    homeDir = mkdtempSync(join(tmpdir(), 'amawta-output-style-home-'))
  ...
  test('direct set persists outputStyle to .amawta/settings.local.json', async () => {
