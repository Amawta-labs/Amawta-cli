...
} from '@utils/protocol/agentStreamJson'
...
describe('stream-json helpers', () => {
  ...
  test('maps user/assistant messages and normalizes tool_use block types', () => {
    ...
    const sdkUser = amawtaMessageToSdkMessage(user as any, sessionId)
    ...
    const sdkAssistant = amawtaMessageToSdkMessage(assistant as any, sessionId)
