...
export function AskUserQuestionPermissionRequest({
  ...
  return (
    <Box flexDirection="column" marginTop={1}>
      <Box marginBottom={1}>
        <Text color={theme.secondaryText}>Amawta Selector</Text>
      </Box>
      <Box
        borderTop
                ...
                return (
                  <>
                    {currentQuestion.options.map((option, index) => {
                      ...
                      const color = isFocused ? theme.amawta : theme.text
                    ...
                    <Box flexDirection="column">
                      <Text color={isOtherFocused ? theme.amawta : theme.text}>
                    ...
                    {currentQuestion.multiSelect && (
                      <Box marginTop={0}>
                        <Text
                          color={
                            isMultiSelectSubmitFocused ? theme.amawta : theme.text
                          }
