...
export const WebSearchTool = {
  ...
  async *call(
    ...
    try {
      const rawResults = await searchProviders.google.search(
        query,
        undefined,
        {
      ...
      const isAbort =
        ...
        /aborted|cancelled|timed? out/i.test(
      ...
      const output: Output = {
        ...
        results: [
          isAbort
            ? `Web search interrupted or timed out after ${Math.round(WEB_SEARCH_TIMEOUT_MS / 1000)}s`
