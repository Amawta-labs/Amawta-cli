...
export const AskUserQuestionTool = {
  ...
  userFacingName() {
    // Hide the tool_use line; the interactive UI renders its own selector header.
    return ''
  },
  inputSchema,
  isReadOnly() {
  ...
  renderToolUseRejectedMessage() {
    ...
    return (
      <Box flexDirection="row" marginTop={1}>
        ...
        <Text>User cancelled Amawta Selector</Text>
      </Box>
    )
  },
    ...
    return (
      <Box flexDirection="column" marginTop={1}>
        <Box flexDirection="row">
          <Text color={theme.text}>{BLACK_CIRCLE}&nbsp;</Text>
          <Text>User answered Amawta Agent&apos;s questions:</Text>
        </Box>
