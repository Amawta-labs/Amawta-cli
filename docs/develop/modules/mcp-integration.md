...
The MCP Integration module (`src/services/mcpClient.ts`) enables Amawta to connect with external tools and services through the Model Context Protocol. MCP allows third-party developers to create servers that provide additional capabilities to AI assistants.
