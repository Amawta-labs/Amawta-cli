# Amawta System Overview

## Introduction

Amawta is an AI-powered terminal assistant that brings the power of Claude and other language models directly to your command line. It's designed as a sophisticated development tool that understands your codebase, executes commands, and handles complex workflows through natural language interaction.

## Core Design Philosophy

### 1. **Tool-First Architecture**
Everything in Amawta is abstracted as a "Tool" - a self-contained unit of functionality with standardized interfaces for:
...
Unlike web-based AI assistants, Amawta is built specifically for terminal workflows:
...
- Custom command definitions in .claude/commands/ and .amawta/commands/
...
This modular, extensible design ensures Amawta can evolve with user needs while maintaining stability and security.