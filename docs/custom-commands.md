...
Amawta supports custom slash commands through Markdown files placed in `.claude/commands/` or `.amawta/commands/` directories. This feature allows you to create reusable prompts and workflows tailored to your specific needs.

## Directory Structure

Custom commands are loaded from multiple locations (both .claude and .amawta directories are supported):

- **Global commands**: 
  - `~/.claude/commands/` - Available in all projects
  - `~/.amawta/commands/` - Available in all projects
- **Project commands**: 
  - `./.claude/commands/` - Specific to the current project
  - `./.amawta/commands/` - Specific to the current project

Note: Both .claude and .amawta directories work identically for backward compatibility.
...
**File**: `~/.claude/commands/status.md` or `~/.amawta/commands/status.md`
...
**File**: `./.claude/commands/deploy.md` or `./.amawta/commands/deploy.md`
...
**File**: `~/.claude/commands/security.md` or `~/.amawta/commands/security.md`
...
3. Ensure directories exist: `~/.claude/commands/`, `~/.amawta/commands/`, `./.claude/commands/`, or `./.amawta/commands/`
