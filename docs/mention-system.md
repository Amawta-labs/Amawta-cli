...
Amawta's @ mention system provides intelligent auto-completion and smart delegation for models, agents, and files. This unified interface makes it easy to reference different resources and trigger appropriate actions.
...
- User agents (`~/.amawta/agents/`)
- Project agents (`./.amawta/agents/`)
...
- Restart Amawta if completion seems stuck
